...
<div id="container" style="font-size: 16px;">
    ...
    <div id="body">
        <p>您好，您即将进入情景二实验。请您仔细阅读以下的假设情景：</p>
        <p style="color: blue; font-weight: bold">明天，您打算精心挑选一家味美价廉、服务态度好的烤鸭饭店以宴请您好不容易来北京旅游的小伙伴们。</p>
        <p style="color: blue; font-weight: bold">下一网页即是您在您熟悉的点评网站初步挑选出来的一家饭店网页。</p>
